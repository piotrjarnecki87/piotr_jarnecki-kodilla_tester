...
class DictionaryTest {
    ...
    public void testFindEnglishWords(){
        ...
        //then
       List<EnglishWord> expecedList = new ArrayList<>();
       expecedList.add(new EnglishWord(PartOfSpeech.NOUN, "play"));
       expecedList.add(new EnglishWord(PartOfSpeech.NOUN, "game"));
       assertEquals(expecedList, result);
    }
